        ...
        <div class="m-auto">
            ...
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            id="exampleFormControlInput3" placeholder="Meta description..." name="meta_description" />
                    </div>
                    <div class="mb-3 xl:w-96">
                        <input type="text"
                            class="
                    ...
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            id="exampleFormControlInput3" placeholder="Meta Keywords..." name="meta_keywords" />
                    </div>
                    <div class="mb-3 xl:w-96">
                        <input type="text"
                            class="
                    ...
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                            id="exampleFormControlInput3" placeholder="Meta Robots..." name="meta_robots" />
